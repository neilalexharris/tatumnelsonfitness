<?php
	$colClass = "pinktext";
	$logoPath = "Images/Pngs/main_pink.png";
?>
	...
	<body>
		<div style="text-align:center">
			...
			<table class="main" cellpadding="0", cellspacing="0">
				<tr>
				    <td>
						<img src="Images/Photos/philo_banner_text.png"/>
					</td>
				</tr>
			</table>
			...
			<table class="main" cellpadding="0", cellspacing="10">
				<tr>
					<td>
						<h1 class="<?php echo $colClass; ?>" align="center">- My Foundations to Fitness -</h1>
					</td>
				</tr>
			</table>
			...
			<table class="main" cellspacing="10">	
				<tr style="vertical-align:top;">
					<td style="border:1px solid #333; padding:10px;" width="250">
						
						<h1 class="<?php echo $colClass; ?>">Bodyweight Strength</h1>
						<br/>
						...
						<a class="<?php echo $colClass; ?>" href="http://www.trxtraining.com/" target="blank">TRX</a> - to assist in building supreme total body strength, balance 
						and stability. By working the body unilaterally I ensure everyone has a stable base from which to develop and progress.</p>
						<br/>

						<p>At <font class="<?php echo $colClass; ?>">Tatum Nelson Fitness</font>, the focus is on total body strength, and attaining power that belies ones size.</p> 
						
					</td>

					<td style="border:1px solid #333; padding:10px;" width="250">
						
						<h1 class="<?php echo $colClass; ?>">Core Stability</h1>
						<br/>
						...
						<p>At <font class="<?php echo $colClass; ?>">Tatum Nelson Fitness</font>, foundations will be built so the client can continue to achieve.</p>
						
					</td>

					<td style="border:1px solid #333; padding:10px;" width="250">
						
						<h1 class="<?php echo $colClass; ?>">Cardiovascular Fitness</h1>
						<br/>
						...
						<p>At <font class="<?php echo $colClass; ?>">Tatum Nelson Fitness</font> cardiovascular health will lead to you feeling better, having more 
			...
			<table class="main" cellpadding="10", cellspacing="10">
				<tr>
					<td>
						<h1 class="<?php echo $colClass; ?>">The Way I Work</h1><br/>
						...
						<p><h1 class="<?php echo $colClass; ?>">> Tatum Nelson Fitness for Him</h1>
						...
						<p><h1 class="<?php echo $colClass; ?>">> Tatum Nelson Fitness For Her</h1>
						...
						<p><font class="<?php echo $colClass; ?>">Tatum Nelson Fitness</font> - where fitness is a lifestyle.</p>
					</td>
				</tr>
			</table>
